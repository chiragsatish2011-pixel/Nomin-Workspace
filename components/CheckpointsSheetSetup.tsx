        ...
        <div className="mt-4">
          ...
          {!health.ready && (
            <button
              ...
              disabled={working}
              className="mt-4 inline-flex items-center gap-2 rounded-xl bg-kraken px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:opacity-90 transition-opacity disabled:opacity-50"
            >
              {working
                ? "Setting up…"
                : health.configured
