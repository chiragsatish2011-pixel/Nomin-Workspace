 ...
 * prompt. Sits on the Kraken-purple brand panel. Pure CSS animation, no JS.
 */
export function ConsoleMock() {
  return (
    <div className="w-full overflow-hidden rounded-2xl border border-white/10 bg-[#101114] text-white shadow-[0_24px_80px_-24px_rgba(20,8,60,0.8)]">
      <div className="flex items-center gap-2 border-b border-white/10 px-5 py-3.5">
        ...
        <span className="ml-auto hidden items-center gap-1.5 rounded-md bg-[#149e61]/25 px-2.5 py-1 font-mono text-[10px] font-semibold uppercase tracking-[0.1em] text-[#4ade80] sm:inline-flex">
          <span className="h-1.5 w-1.5 animate-pulse-dot rounded-full bg-[#4ade80]" />
          Online
        </span>
      </div>
