    ...
    <span className="flex shrink-0 flex-col items-end gap-2">
      <span className="flex shrink-0 gap-2">
        <button
          ...
          className="press rounded-xl border border-hairline px-3.5 py-1.5 text-xs font-semibold text-charcoal transition-colors duration-200 hover:border-kraken hover:text-ink"
        >
          Change password
        </button>
        {!isSelf && (
        ...
        >
          ...
          <span className="flex gap-2">
            <button
              type="submit"
              disabled={busy}
              className="press flex-1 rounded-xl bg-kraken px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-kraken-deep disabled:cursor-wait disabled:opacity-60"
            >
              {busy ? "Saving…" : "Save"}
            </button>
            <button
