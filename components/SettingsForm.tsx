...
export function SettingsForm({
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="mt-3 flex items-center gap-3">
          ...
          <button
            ...
            className="rounded-lg border border-hairline bg-canvas px-4 py-2 text-xs font-semibold hover:border-kraken disabled:opacity-50"
          >
          ...
          {avatarId && (
            <button
              ...
              disabled={uploadingAvatar}
              className="rounded-lg border border-hairline px-4 py-2 text-xs font-medium text-steel hover:border-kraken hover:text-ink disabled:opacity-50"
            >
              Remove
            </button>
          )}
      ...
      {/* Profile — display name + Nomin field/role */}
      <div className="border-t border-hairline-soft pt-5 space-y-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={savingName}
            className="rounded-xl bg-kraken px-5 py-2 text-xs font-semibold text-white hover:bg-kraken-deep disabled:opacity-50"
          >
      ...
      <form onSubmit={handlePasswordChange} className="border-t border-hairline-soft pt-5">
        ...
        <button
          type="submit"
          disabled={savingPw}
          className="mt-3 rounded-xl bg-kraken px-5 py-2 text-xs font-semibold text-white hover:bg-kraken-deep disabled:opacity-50"
        >
