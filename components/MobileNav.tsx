          ...
          <li key={item.href}>
            <Link
              ...
              className={`group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors duration-200 ${
                isActive
                  ? "bg-brand-subtle font-semibold text-brand-dark dark:text-brand"
                  : showDot
                    ? "bg-brand-subtle/60 font-medium text-ink hover:bg-brand-subtle"
                    : "text-charcoal hover:bg-fog"
              } ${showDot && !isActive ? "ring-1 ring-brand/25" : ""}`}
            >
