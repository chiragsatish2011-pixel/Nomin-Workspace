  ...
  return (
    <>
      <button
        ...
        className="press grid h-10 w-10 place-items-center rounded-xl border border-hairline bg-canvas text-ink lg:hidden"
      >
      ...
      >
        <div className="flex items-center justify-between border-b border-hairline-soft px-5 py-4">
          ...
          <button
            ...
            className="press grid h-10 w-10 place-items-center rounded-xl border border-hairline text-ink"
          >
