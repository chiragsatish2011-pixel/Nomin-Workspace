  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center bg-ink/60 p-4 backdrop-blur-sm">
      <div className="w-full max-w-lg rounded-3xl border border-hairline bg-canvas p-6 sm:p-8 shadow-2xl">
        ...
        {step === 1 && (
          <div className="mt-6">
            <p className="font-mono text-xs uppercase tracking-[0.24em] text-stone">Welcome to Nomin</p>
            ...
            <div className="mt-6 flex justify-end">
              <button
                disabled={!canNext1}
                onClick={() => setStep(2)}
                className="rounded-xl bg-kraken px-6 py-2.5 text-sm font-semibold text-white disabled:opacity-40"
              >
                Continue
              </button>
            </div>
        ...
        {step === 2 && (
          <div className="mt-6">
            ...
            <p className="mt-2 text-sm text-steel">Where do you do your best work at Nomin? This helps teammates find you.</p>
            <div className="mt-5 grid gap-2">
              {[
                { id: "Design", desc: "Product, visual, brand — crafting how Nomin looks and feels." },
                { id: "Engineering", desc: "Frontend, backend, full-stack — building the product." },
                { id: "Marketing", desc: "Growth, content, comms — sharing Nomin with the world." },
              ].map((d) => (
                <button
                  key={d.id}
            ...
            <div className="mt-6 flex justify-between">
              ...
              <button disabled={!canNext2} onClick={() => setStep(3)} className="rounded-xl bg-kraken px-6 py-2.5 text-sm font-semibold text-white disabled:opacity-40">
                Continue
              </button>
            </div>
          </div>
        ...
        {step === 3 && (
          <div className="mt-6">
            ...
            <h2 className="mt-2 font-display text-2xl font-bold tracking-tight">What&apos;s your role at Nomin?</h2>
              ...
              {(() => {
                ...
                return (
                  <button
                    ...
                    className="rounded-lg border border-hairline bg-fog px-3 py-1 text-xs font-medium hover:border-kraken"
                  >
                    Use “{suggestion}”
                  </button>
                );
            ...
            <div className="mt-6 flex justify-between">
              ...
              <button disabled={!canFinish || saving} onClick={handleFinish} className="rounded-xl bg-kraken px-6 py-2.5 text-sm font-semibold text-white disabled:opacity-40">
