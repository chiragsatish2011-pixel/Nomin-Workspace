...
/** Kraken badge (8px radius: NEW coral · BETA pale-blue · LIVE green). */
export function Badge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 rounded-lg px-2.5 py-1 font-mono text-[11px] font-medium uppercase tracking-[0.08em] ${
