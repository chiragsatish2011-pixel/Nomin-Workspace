...
export function CreateAccountForm() {
  ...
  return (
    <div>
      <form onSubmit={onSubmit} className="flex flex-col gap-4">
        ...
        <div>
          ...
          <button
            ...
            className="press mt-2 inline-flex h-10 items-center rounded-xl border border-kraken-dark px-5 text-sm font-semibold text-kraken-dark transition-colors duration-200 hover:bg-kraken-subtle"
          >
            Generate password
          </button>
        </div>
      ...
      {created && (
        <div className="mt-6 animate-fade-in rounded-2xl bg-[#2a1065] p-6 text-white">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <button
              ...
              className="press h-12 shrink-0 rounded-xl bg-white px-5 text-sm font-semibold text-ink transition-opacity hover:opacity-90"
            >
              {copied ? "Copied" : "Copy"}
            </button>
          </div>
