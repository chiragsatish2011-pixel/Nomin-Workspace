...
const ChonkyDrive = dynamic(() => import("@/components/files/ChonkyDrive").then(m => m.ChonkyDrive), { ssr: false, loading: () => <div className="flex flex-1 flex-col bg-[#f7f7fa] p-6 dark:bg-[#0b0b11]"><div className="h-64 animate-pulse rounded-2xl bg-white shadow-sm dark:bg-[#1c1c26]" /></div> });
...
export function FilesManager() {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-[#f7f7fa] dark:bg-[#0b0b11]">
