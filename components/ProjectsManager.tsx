      ...
      {showOrphans && orphans.length > 0 && (
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4">
          <p className="text-sm font-semibold text-amber-900">
            Found {orphans.length} {orphans.length === 1 ? "item" : "items"} in Drive with no project record — likely from interrupted batch (e.g. “Nomin core” 27k files). Recover without re-uploading.
          </p>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-5">
              ...
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. Nomin Core Client v1.0"
                  maxLength={100}
                  value={title}
