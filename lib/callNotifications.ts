...
export const APP_ENABLED_KEY = "nomin:call-notifications:enabled";
export const PREPROMPT_DISMISSED_KEY = "nomin:call-notifications:preprompt-dismissed";
