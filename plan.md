# Nomin Workspace — Build Plan (v2: Custom Build on Vercel + Google Drive)
...
- **Outcome:** Team members can create accounts and log into Nomin Workspace — no Google account needed on their end.
...
- **Outcome:** One-click voice/video calls between team members, launched from inside Nomin Workspace.
...
- **Outcome:** A cohesive, branded "Nomin Workspace" experience, not just three separate features bolted together.
