            ...
            {hasClientId && hasClientSecret && (
              <div className="mt-6 pt-5 border-t border-hairline-soft flex items-center justify-between flex-wrap gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-kraken px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:opacity-90 transition-opacity"
                >
            ...
            <ol className="mt-6 space-y-4 text-sm text-steel">
              <li className="flex gap-4">
                ...
                <p>
                  ...
                  <strong>Nomin Checkpoints</strong> and rename its first tab to{" "}
