...
export default async function DashboardPage() {
  ...
  return (
    ...
    >
      ...
      <section className="relative overflow-hidden pt-10 sm:pt-14">
        ...
        <div className="relative">
          ...
          >
            <a
              href="#sections"
              className="press inline-flex h-12 items-center gap-2 rounded-xl bg-kraken px-7 text-sm font-semibold text-white transition-colors duration-200 hover:bg-kraken-deep"
            >
              Explore sections
            ...
            <a
              href="#roadmap"
              className="press inline-flex h-12 items-center rounded-xl border border-kraken-dark px-7 text-sm font-semibold text-kraken-dark transition-colors duration-200 hover:bg-kraken-subtle"
            >
              View roadmap
            </a>
          </div>
      ...
      {/* ── Marquee band ── */}
      <section aria-hidden className="marquee-mask -mx-4 mt-10 overflow-hidden bg-kraken py-3.5 sm:-mx-6">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-hairline bg-canvas p-6">
              ...
              <div className="mt-4 flex gap-2">
                <Link href="/projects" className="rounded-xl bg-kraken px-4 py-2 text-xs font-semibold text-white hover:bg-kraken-deep">Publish project</Link>
                <Link href="/files" className="rounded-xl border border-hairline px-4 py-2 text-xs font-semibold hover:border-kraken">Browse files</Link>
              </div>
            </div>
            <div className="rounded-2xl border border-hairline bg-canvas p-6">
              <div className="flex items-center justify-between">
              ...
              <div className="mt-4 flex gap-2">
                <Link href="/checkpoints" className="rounded-xl bg-kraken px-4 py-2 text-xs font-semibold text-white hover:bg-kraken-deep">Open canvas</Link>
                <Link href="/chat" className="rounded-xl border border-hairline px-4 py-2 text-xs font-semibold hover:border-kraken">Open chat</Link>
              </div>
            </div>
          </div>
        </Reveal>
