      ...
      <div className="relative flex-1 overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-2xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          <div className="mt-6 animate-fade-up" style={{ animationDelay: "200ms" }}>
                ...
                {status.isProduction ? (
                  <div className="mt-4 space-y-4 text-[15px] leading-relaxed text-charcoal">
                    ...
                    <button
                      ...
                      className="press inline-flex h-11 items-center rounded-xl border border-kraken-dark px-6 text-sm font-semibold text-kraken-dark transition-colors duration-200 hover:bg-kraken-subtle"
                    >
                  ...
                  <form onSubmit={saveDatabase} className="mt-5 flex flex-col gap-4">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="press inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-kraken text-sm font-semibold text-white transition-colors duration-200 hover:bg-kraken-deep"
                    >
            ...
            {status && current === 4 && (
              <section className="rounded-2xl border border-hairline bg-canvas p-6 text-center shadow-[0_12px_40px_-24px_rgba(0,0,0,0.25)] sm:p-10">
                ...
                <Link
                  href="/signin"
                  className="press mt-8 inline-flex h-12 items-center rounded-xl bg-kraken px-8 text-sm font-semibold text-white transition-colors duration-200 hover:bg-kraken-deep"
                >
                  Go to sign in
                </Link>
              </section>
          ...
          <p className="mt-8 text-center font-mono text-[11px] uppercase tracking-[0.18em] text-stone">
            Nomin Workspace · setup lives at /setup
          </p>
        </div>
      </div>
    </main>
